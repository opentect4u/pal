...
class Recommends extends MX_Controller {
	...
	public function __construct(){
        ...
        $link['title']  = 'Leave Management Recommend';
    ...
    public function index(){
        ...
        $recommend['leave_dtls']     =   $this->Leave->f_get_particulars_in("td_leaves_trans t, md_employee m", $select, $where_in, $where);
        
        $this->load->view("recommend/dashboard", $recommend);
    ...
    public function f_form(){
        ...
        $data['leave_dtls']    =   $this->Leave->f_get_particulars("td_leaves_trans t, md_employee m", $select, $where, 1);
        ...
        echo $this->load->view('recommend/form', $data, TRUE);
