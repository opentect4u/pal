                        ...
                        <table id="demo-foo-addrow" class="table m-t-30 table-hover contact-list" data-page-size="10">
                            ...
                            <tbody> 
                                ...
                                if($compOff_dtls) {
                                        ...
                                        foreach($compOff_dtls as $e_dtls) {
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-nowrap">
                                                ...
                                                <?php if($e_dtls->recommendation_status == 0){?>
                                                        ...
                                                        <a href="<?php echo site_url('leave/compoff/edit?trans_cd='.$e_dtls->trans_cd.''); ?>"
                                                        title="Edit"
                                                        >
                                ...
                                <tr>
                                    <td colspan="2">
                                        ...
                                        <a class="btn btn-info btn-rounded"
                                           href="<?php echo site_url('leave/compoff/add'); ?>" 
                                         >Add New Comp Off</a>
                        ...
                        <div class="modal fade" tabindex="-1" role="dialog" id="deleteModal" aria-labelledby="mySmallModalLabel" aria-hidden="true" style="display: none;">
                            ...
                            <div class="modal-dialog modal-sm">
                                ...
                                <div class="modal-content">
                                    ...
                                    <form id="delFrom" method="post" action="<?php echo site_url('leave/compoff/delete'); ?>">
