                                        ...
                                        <tr>
                                            ...
                                            <td class="text-nowrap">
                                                ...
                                                <?php if($e_dtls->recommendation_status == 0){?>
                                                        ...
                                                        <a href="<?php echo site_url('leave/half/edit?trans_cd='.$e_dtls->trans_cd.''); ?>"
                                                           title="Edit"
                                                        >
                                ...
                                <tr>
                                    ...
                                    ?>
                                        <a class="btn btn-info btn-rounded"
                                           href="<?php echo site_url('leave/half/add'); ?>" 
                                         >Add New Leave</a>
                                    <?php
                                        }
                                    ?>
                        ...
                        <div class="modal fade" tabindex="-1" role="dialog" id="deleteModal" aria-labelledby="mySmallModalLabel" aria-hidden="true" style="display: none;">
                            ...
                            <div class="modal-dialog modal-sm">
                                ...
                                <div class="modal-content">
                                    ...
                                    <form id="delFrom" method="post" action="<?php echo site_url('leave/half/delete'); ?>">
