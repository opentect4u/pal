						...
						<div class="form-group">
							<div class="row">
								<div class="col-md-6 col-xs-12">
									<p class="pass" style="color: red; display: inline;"></p>
								</div>
								<div class="col-md-6 col-xs-12">
									<a href="javascript:void(0);" style="display: inline;">Forgot Password?</a>
								</div>
							</div>
						</div>
						<div class="form-group">
		...
		<script>
			...
			$(document).ready(function() {
				...
				<?php if($this->session->flashdata('msg')['message']){ ?>
					...
					$('.pass').html('<?php echo $this->session->flashdata('msg')['message']; ?>').show();
